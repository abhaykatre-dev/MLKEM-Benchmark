...
export const AboutPage: React.FC = () => {
  const technologies = [
    ...
    { name: 'React 18 & TypeScript', category: 'Frontend Framework', desc: 'Type-safe single-page application built with Vite' },
  ...
  const teamMembers = [
    { name: 'Final Year CSE Student Team', role: 'Frontend & UI/UX Developer', task: 'React, TypeScript, Tailwind CSS, Recharts dashboard design & API integration' },
    { name: 'Backend & Simulation Teammates', role: 'Embedded Systems & AI Engineers', task: 'Renode firmware compilation, Python dataset analysis & AI recommendation engine' },
  ];
      ...
      <Card className="p-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-5 gap-3">
          ...
          <div className="p-3 rounded bg-stone-50 border border-slate-200 text-center">
            ...
            <p className="text-[11px] text-slate-500 leading-snug">Explore data, view analytics & AI recommendation UI</p>
          </div>
        </div>
      </Card>
