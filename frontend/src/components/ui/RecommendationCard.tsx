    ...
    <Card className="p-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-200 pb-4 mb-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="text-xs uppercase font-semibold tracking-wider text-slate-500">AI Recommendation Output</span>
        ...
        <div className="flex items-center gap-2 bg-stone-50 px-3.5 py-1.5 rounded-md border border-slate-200">
      ...
      {/* Reason text */}
      <div className="bg-stone-50 p-4 rounded-md border border-slate-200 mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-white p-3.5 rounded-md border border-slate-200 flex flex-col justify-between">
          ...
          <p className="text-xs text-slate-600 mt-2">
            Total latency ({((estimatedKeygenUs + estimatedEncapUs + estimatedDecapUs) / 1000).toFixed(1)} ms) evaluated against application target.
          </p>
        </div>
      </div>
