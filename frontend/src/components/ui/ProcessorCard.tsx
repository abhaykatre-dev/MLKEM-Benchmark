    ...
    <Card className="flex flex-col justify-between h-full">
      <div>
        <div className="flex items-start justify-between gap-2 mb-3">
          ...
          <div className="p-2 rounded-md bg-stone-100 border border-slate-200 text-slate-700">
        ...
        <div className="grid grid-cols-3 gap-2 bg-stone-50 p-2.5 rounded-md border border-slate-200 mb-4">
