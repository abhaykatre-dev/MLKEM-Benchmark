/**
 * benchmark.c — nRF52840 Profile (ARM Cortex-M4 @ 64 MHz)
 * TIM2 Microsecond Hardware Precision Benchmark Driver
 */
...
void benchmark_run_all(void)
{
    ...
    uart_print("  Target Processor: Nordic nRF52840 Profile (Cortex-M4 @ 64 MHz)\r\n");
    uart_print("  Clock Speed:      64 MHz | TIM2 Microsecond Hardware Timing\r\n");
    uart_print("  Memory Specs:     1024 KB Flash | 256 KB SRAM\r\n");
    ...
    uart_print("\r\n=======================================================\r\n");
    uart_print("  nRF52840 BENCHMARK SUITE COMPLETE!\r\n");
    uart_print("=======================================================\r\n");
}
