/**
 * benchmark.c — STM32H753ZIT6 (ARM Cortex-M7 @ 480 MHz)
...
void benchmark_run_all(void)
{
    ...
    uart_print("  Target Processor: STM32H753ZIT6 (ARM Cortex-M7F)\r\n");
    uart_print("  Clock Speed:      480 MHz | TIM2 Microsecond Hardware Timing\r\n");
    uart_print("  Memory Specs:     2048 KB Flash | 1024 KB SRAM\r\n");
    ...
    uart_print("\r\n=======================================================\r\n");
    uart_print("  STM32H7 BENCHMARK SUITE COMPLETE!\r\n");
    uart_print("=======================================================\r\n");
}
